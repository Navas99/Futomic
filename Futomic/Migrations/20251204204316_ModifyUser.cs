        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Paymen = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamFields", x => new { x.FieldsFieldId, x.TeamsTeamId });
                    table.ForeignKey(
                        name: "FK_TeamFields_Fields_FieldsFieldId",
                        column: x => x.FieldsFieldId,
                        principalTable: "Fields",
                        principalColumn: "FieldId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamFields_Teams_TeamsTeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamFields_TeamsTeamId",
                table: "TeamFields",
                column: "TeamsTeamId");
